...
- 第4部 4.5 から 4.7 で、史料に残る陰陽師・陰陽道、伝承・物語としての陰陽師、現代文化の中の陰陽師イメージを分ける。
- 第4部 4.8 で、デジタル技術と比較しているのは職能や宗教的意味ではなく、状態を読み、記号化し、作法化し、代理的な働きを通じて現実へ作用させる問題の型だと限定する。
...
- 第4部 4.12 で、陰陽や符よりも日常語に近い制御感覚として、「気を遣う」「気を配る」「気を回す」「気が合う」「気配を読む」を扱う。
...
- 第4部 4.9 で、`code`、`符`、`符号`、`符文` を、語源の同一視ではなく、しるし、規則体系、形式、照合、実行条件の構造的対応として扱う。
...
- 第4部 4.7 で、映画『陰陽師』を、陰陽道史の根拠ではなく、現代日本語話者に共有されたポップカルチャー上の認知インターフェースとして扱う。
...
- 第4部 4.14 で、魔法、魔人（ジン）、符、呪文、陰陽、式神を、技術の本質ではなく、状態、操作、接続、伝搬、制御の構造を見えるようにする補助線として扱う。
